...
public class AstarPath : VersionedMonoBehaviour
{
    ...
    public static void FindAstarPath()
    {
        ...
        // Use FindFirstObjectByType<AstarPath>() instead of FindObjectOfType<AstarPath>()
        if (active == null) active = UnityEngine.Object.FindFirstObjectByType<AstarPath>();
    ...
    protected override void Awake()
    {
        ...
        var instances = UnityEngine.Object.FindObjectsByType<AstarPath>(FindObjectsInactive.Include, FindObjectsSortMode.None);
#else
	var instances = UnityEngine.Object.FindObjectsOfType<AstarPath>();
#endif
